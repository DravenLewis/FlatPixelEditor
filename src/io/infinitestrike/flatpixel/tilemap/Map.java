...
import io.infinitestrike.flatpixel.components.RenderPane.Drawable;
...
import io.infinitestrike.utils.FPStringUtils;
...
public class Map implements Drawable {
	...
	public static Map openMap(File location) {
		...
		try {
			...
			Console.Log("[Map::OpenMap] Tileset Image: " + tilesetFilePath);
			
			//if(tilesetFilePath.equals("null")) {
			//	Console.Log("Cannot Read Map: Cannot load value of key $TILE_SET");
			//	return null;
			//}
			...
			Console.Log("Tile Set Image: " + tilesetFilePath);
			Console.Log("=====================================================");
	...
	public static void saveMap(Map m, File location) {
		Thread t = new Thread(new Runnable() {
			...
			public void run() {
				...
				Console.Log("Tiles: " + m.getTileMap().getTiles().length);
				Console.Log("Layers: " + m.getLayers().size());
				Console.Log("Tile Set Image: " + Settings.getCurrentTilesetFile().getName());
				Console.Log("=====================================================");
			}
		});
		t.start();
