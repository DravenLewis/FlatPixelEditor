...
import io.infinitestrike.utils.TextFieldUtils;
...
public class SettingsWindow extends JPanel{
	...
	public void init() {
		if(Settings.getSettings() == null) return;
		this.setLayout(new BoxLayout(this,BoxLayout.Y_AXIS));
		
		LoaderResult r = Settings.getSettings();
		for(int i = 0; i < r.size(); i++){
			...
			case BOOL:
				...
				b.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						Settings.getSettings().set(keyName, new LoaderEntry(type, "" + b.isSelected()));
					}
				});
				internal.add(l);
				internal.add(b);
			...
			case FLOAT:
				...
				sf.addKeyListener(new KeyAdapter() {
					public void keyReleased(KeyEvent e) {
						...
						Settings.getSettings().set(keyName, new LoaderEntry(type,sf.getText()));
					}
				});
			...
			case HEX:
				...
				sh.addKeyListener(new KeyAdapter() {
					public void keyReleased(KeyEvent e) {
						...
						Settings.getSettings().set(keyName, new LoaderEntry(type,sh.getText()));
						sh.setBackground(new Color(Loader.getValueHex(r.valueOf(keyName, "e3e3e3"))));
						int textColor = (Loader.getValueHex(r.valueOf(keyName, "e3e3e3")) >= 0x888888) ? 0x0 : 0xFFFFFF; 
						sh.setForeground(new Color(textColor));
					}
				...
				picker.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(c != null) {
							...
							sh.setText(hexColor);
							Settings.getSettings().set(keyName, new LoaderEntry(type,hexColor));
							sh.setBackground(new Color(Loader.getValueHex(r.valueOf(keyName, "e3e3e3"))));
							int textColor = (Loader.getValueHex(r.valueOf(keyName, "e3e3e3")) >= 0x888888) ? 0x0 : 0xFFFFFF; 
							sh.setForeground(new Color(textColor));
						}
			...
			case INT_32:
				...
				si.addKeyListener(new KeyAdapter() {
					public void keyReleased(KeyEvent e) {
						...
						Settings.getSettings().set(keyName, new LoaderEntry(type,si.getText()));
					}
				});
			...
			case INT_64:
				...
				sl.addKeyListener(new KeyAdapter() {
					public void keyReleased(KeyEvent e) {
						...
						Settings.getSettings().set(keyName, new LoaderEntry(type,sl.getText()));
					}
				});
			...
			case DIR:
				...
				dir.addKeyListener(new KeyAdapter() {
					public void keyReleased(KeyEvent e) {
						Settings.getSettings().set(keyName, new LoaderEntry(type,dir.getText()));
					}
				});
				...
				browse.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(choice == JFileChooser.APPROVE_OPTION) {
							...
							dir.setText(f);
							Settings.getSettings().set(keyName, new LoaderEntry(type,f));
						}
					}
				});
			...
			case STRING:
				...
				s.addKeyListener(new KeyAdapter() {
					public void keyReleased(KeyEvent e) {
						Settings.getSettings().set(keyName, new LoaderEntry(type,s.getText()));
					}
				});
					...
					if(optionArray[0] != null) {
						...
						choices.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
								...
								Settings.getSettings().set(keyName, tempEntry);
							}
						});
						internal.add(l);
